...
SERIES = [
    ...
    ("HCTB / HCTT", "HCTB-HCTT", "Çatı Tipi Aksiyel Fanlar", "Roof Fan", "hctb-hctt-20260827.jpg", r"\bHCT[BT]/\d(?:/\d)?-\d+(?:-[A-Z])?\b"),
    ...
    ("HXBR / HXTR", "HXBR-HXTR", "Duvar Tipi Aksiyel Fanlar", "Wall Fan", "hxbr-hxtr-20260827.jpg", r"\bHXT?[BR]/\d(?:/\d)?-\d+(?:-[A-Z])?\b"),
    ...
    ("TH-MIXVENT", "TH-MIXVENT", "Yatay Atışlı Çatı Tipi Karma Akışlı Fanlar", "Roof Fan", "th-mixvent-20260827.jpg", r"\bTH-(?:\d+/\d+|\d+\s*N?)\b"),
