...
CATALOGUES = {
    ...
    "IRB-IRT.pdf": {
        "sha256": "ffa41f75f22caa08247e4f812d1771513bc36c19fb012959e1a99b4694330d23",
        "graphs": [
            ("IRB/2-180", 3, 761), ("IRB/2-200 A", 3, 797),
            ("IRB/2-200 B", 4, 19), ("IRB/4-225", 4, 798),
            ("IRB/4-315 A", 5, 761), ("IRB/4-315 B", 5, 797),
            ("IRB/6-315", 6, 19), ("IRB/4-355", 6, 798),
            ("IRB/6-355", 7, 761), ("IRB/6-400", 7, 1539),
            ("IRB/6-450", 8, 19), ("IRT/4-315 A", 8, 1358),
            ("IRT/4-315 B", 9, 579), ("IRT/4-355", 9, 1167),
            ("IRT/6-355", 10, 579), ("IRT/4-400 A", 10, 609),
            ("IRT/4-400 B", 11, 579), ("IRT/6-400", 11, 1172),
            ("IRT/4-450", 12, 579), ("IRT/6-450", 12, 1172),
        ],
    },
}
