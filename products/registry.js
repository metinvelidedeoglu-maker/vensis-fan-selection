  ...
  function modelFromRow(row){
    ...
    const record={
      ...
      technical:{
        ...
        soundInletDbA1_5m:finite(row?.soundInletDbA1_5m),
        soundRadiatedDbA1_5m:finite(row?.soundRadiatedDbA1_5m),
        soundOutletDbA1_5m:finite(row?.soundOutletDbA1_5m),
        current230A:finite(row?.current230A),
        current400A:finite(row?.current400A),
