(function(){
  ...
  const translations={
    ...
    'Project details will open before the first fan is added.':'İlk fan eklenmeden önce proje bilgileri açılacaktır.',
    'Complete project and customer details first':'Önce proje ve müşteri bilgilerini tamamlayın',
    ...
    'Create a project and connect it to a complete customer record.':'Projeyi eksiksiz bir müşteri kaydına bağlayarak oluşturun.',
    'Required:':'Zorunlu:',
    'Company name, contact person, and at least one phone number or email address.':'Firma adı, ilgili kişi ve telefon veya e-postadan en az biri.',
    ...
    'Select an existing customer or enter a new company.':'Mevcut müşteriyi seçin veya yeni firma girin.',
    'Enter phone number':'Telefon numarası girin',
    'Enter email address':'E-posta adresi girin',
    'Phone or email: at least one is required.':'Telefon veya e-postadan en az biri zorunludur.',
    'Save Customer & Create Project':'Müşteriyi Kaydet ve Projeyi Oluştur',
    'Duplicate Project':'Projeyi Kopyala',
    'Complete customer details before duplicating this project.':'Projeyi kopyalamadan önce müşteri bilgilerini tamamlayın.',
    'Save Customer & Duplicate Project':'Müşteriyi Kaydet ve Projeyi Kopyala',
    'Copy':'Kopya',
    'product will be added after the project is created.':'ürün proje oluşturulduktan sonra eklenecek.',
    'products will be added after the project is created.':'ürün proje oluşturulduktan sonra eklenecek.',
    'contact person':'ilgili kişi',
    'phone or email':'telefon veya e-posta',
    'New customer — details will be saved to the customer list.':'Yeni müşteri — bilgiler müşteri listesine kaydedilecek.',
    'Existing customer found. Complete missing information:':'Mevcut müşteri bulundu. Eksik bilgileri tamamlayın:',
    'Existing customer found. Details are ready.':'Mevcut müşteri bulundu. Bilgiler hazır.',
    'Project name is required.':'Proje adı zorunludur.',
    'Contact person is required.':'İlgili kişi zorunludur.',
    'Enter at least one phone number or email address.':'En az bir telefon numarası veya e-posta adresi girin.',
    'Enter a valid email address.':'Geçerli bir e-posta adresi girin.',
    'Customer records are unavailable. Please try again.':'Müşteri kayıtlarına ulaşılamıyor. Lütfen tekrar deneyin.',
    'Project could not be created. Please try again.':'Proje oluşturulamadı. Lütfen tekrar deneyin.',
    'Cancel':'İptal',
    'Draft':'Taslak',
  ...
  Object.assign(translations,{
    ...
    'Company details, contacts and commercial activity in one clear workspace.':'Firma bilgileri, iletişim ve ticari hareketler tek bir çalışma alanında.',
    ...
    'with full details':'tam bilgili',
    'with contact details':'iletişim bilgili',
    'Linked Projects':'Bağlı Projeler',
    'Customer-related workspaces':'Müşterilerle bağlantılı çalışma alanları',
    'Quotations':'Teklifler',
    'Projects with a quotation':'Teklif oluşturulmuş projeler',
    'Orders':'Siparişler',
    'Created purchase orders':'Oluşturulan satın alma siparişleri',
    'DIRECTORY':'REHBER',
    ...
    'LEGAL & BILLING':'RESMİ & FATURA',
    'Company Details':'Firma Bilgileri',
    ...
    'Choose a customer from the list to review company details, quotations, orders and project activity.':'Firma bilgilerini, teklifleri, siparişleri ve proje hareketlerini görmek için listeden bir müşteri seçin.',
    'Choose a customer from the list to review contact details, quotations, orders and project activity.':'İletişim bilgilerini, teklifleri, siparişleri ve proje hareketlerini görmek için listeden bir müşteri seçin.',
    'CUSTOMER RECORD':'MÜŞTERİ KAYDI',
    'Keep commercial and invoicing details complete.':'Ticari ve fatura bilgilerini eksiksiz tutun.',
    'Keep customer contact details up to date.':'Müşteri iletişim bilgilerini güncel tutun.',
    'Save Customer':'Müşteriyi Kaydet',
    'Details missing':'Bilgiler eksik',
    'Quotations and orders':'Teklifler ve siparişler',
    'Company details need completion':'Firma bilgileri tamamlanmalı',
    'Contact details need completion':'İletişim bilgileri tamamlanmalı',
    ...
    'Search company, contact, phone or email':'Firma, yetkili, telefon veya e-posta ara',
    'Company Name':'Firma Adı',
