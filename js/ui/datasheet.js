(function(){
  ...
  function normalizePayload(payload={}){
    ...
    const control=String(model.control||performance.control||'');
    const controls=(performance.controls||[]).filter(Boolean);
    return {
      ...
      technical:{fireRating:technical.fireRating||model.fireRating||'',fanType:technical.fanType||model.fanType||'',mountType:technical.mountType||model.mountType||'',ipClass:technical.ipClass||model.ipClass||'',productCode:technical.productCode||model.productCode||''},
