(function(){
  ...
  if(accessorySuitePages.some(item=>path.endsWith(item))){
    document.write(`<script src="${base}js/accessory-core.js?v=20260908-no-code-r1"><\/script><script src="${base}js/accessory-suite.js?v=20260908-empty-image-box-r1"><\/script>`);
  }
