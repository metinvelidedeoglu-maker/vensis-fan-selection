(function(){
  ...
  function loadCatalogueNames(){if(document.querySelector('script[data-vensis-catalog-images]'))return;const script=document.createElement('script');script.src='js/catalog-series.js?v=20260717-images2';script.dataset.vensisCatalogImages='1';script.onload=()=>window.VensisCatalog?.apply(document);document.head.appendChild(script)}
