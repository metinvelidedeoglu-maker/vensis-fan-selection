(function(){
  if(window.__vensisCatalogProjectBridge)return;
  window.__vensisCatalogProjectBridge=true;
  ...
  function add(id,button){
    ...
    const baseKey=`catalog|${productKey}`;
